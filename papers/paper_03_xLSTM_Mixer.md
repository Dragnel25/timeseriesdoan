...
- **Kết quả chính:** Vượt qua các mô hình SOTA hiện tại trong tác vụ dự báo dài hạn (Long-term forecasting), đồng thời tối ưu tài nguyên, giảm thiểu đáng kể số lượng tham số cần huấn luyện và yêu cầu bộ nhớ (memory footprint), vượt trội hoàn toàn so với Transformer về mặt tiêu thụ tài nguyên phần cứng nhờ cơ chế chia sẻ trọng số.
